 ...
 */
 ...
 [_QWERTY] = LAYOUT(
  ...
  KC_LCTL,  DK_A,   DK_S,    DK_D,    DK_F,    DK_G,                     DK_H,    DK_J,    DK_K,    DK_L,    DK_AE,   DK_OSTR,
  KC_LSFT,  DK_Z,   DK_X,    DK_C,    DK_V,    DK_B, DK_LPRN,  DK_RPRN,  DK_N,    DK_M,    DK_COMM, DK_DOT,  DK_MINS,  KC_RSFT,
...
[_RAISE] = LAYOUT(
  ...
  _______, _______, _______, _______, _______, _______,  DK_LBRC, DK_RBRC,  _______, _______, _______, _______, _______, _______,
